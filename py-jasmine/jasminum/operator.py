...
def add(arg1: J, arg2: J) -> J:
    if isinstance(arg1, J) and isinstance(arg2, J):
        ...
        elif arg1.j_type.value <= 2 and arg2.j_type <= 7:
            return add(arg2, arg1)
        elif arg1.j_type == JType.DATE and (
            arg2.j_type == JType.TIME or arg2.j_type == JType.DURATION
        ):
            return J(arg1.nanos_from_epoch() + arg2.data, JType.TIMESTAMP)
        else:
            raise JasmineEvalException(
                "unsupported op '{0}' between '{1}' and '{2}'".format(
